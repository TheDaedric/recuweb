'use strict'
const Repuestos = use('App/Models/Repuesto')
const Hojas = use('App/Models/Hojadeparte')
const Mecanicos = use('App/Models/Mecanicoresponsable')
...
class RepuestoController {
    ...
    async edit({ params, request, response, view }) {
        ...
        let mecanicos = await Mecanicos.all();
        let hojas = await Hojas.all();
        return view.render('repuesto.edit', { repuesto: repuesto, mecanicos: mecanicos.rows, hojas: hojas.rows })
    }
